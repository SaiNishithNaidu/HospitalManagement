...
<body>
	...
	<center><div class="second">
		...
		<h3>Login</h3>
		<input type="text" name="username" style="width: 94%; height: 30px; padding-left: 15px;" placeholder="Username" required="required" 
		/><br><br>
		<input type="password" name="password" style="width: 94%; height: 30px; padding-left: 15px;" placeholder="Password" required="required" /><br>
