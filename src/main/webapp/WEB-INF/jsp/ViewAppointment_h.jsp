...
<%@page import="java.util.List"%><%@ include file="HospitalAdmin/header.jspf"%>
<div class="second">
...
<%@ include file="HospitalAdmin/ViewAppointment.jspf"%>
	...
	<th>Approve/Reject</th>
			...
			<td><a href="/ViewAppointmentAccept_h?accept=<%=s.get(j).getId()%>"><button class="btn btn-success">Approve</button></a>
			<a href="/ViewAppointmentReject_h?reject=<%=s.get(j).getId()%>"><button class= "btn btn-danger">Reject</button></a></td>
